...
![Inspector with the Motif section expanded](img/6-1-motif-section.png)
...
Click either swatch to open the colour picker. The change is
immediate — Curvz repaints the canvas as you adjust the colour.

![The Workspace colour swatch open in the picker](img/6-1-workspace-color-picker.png)
...
- **Fill & stroke** (see 6.2) covers per-object fill and stroke
  paints.
- **Swatches & palettes** (see 6.3) covers the project's named
  colour library.
- **Themes** (see 6.5) covers how Curvz packages full appearance
  presets you can apply across projects.

If you want to change render mode (Preview vs. Outline) or toggle
rulers, those live under view options instead — see 7.1.
