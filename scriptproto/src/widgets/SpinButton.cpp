// SpinButton.cpp ─────────────────────────────────────────────────────────────
//
// Construction shape: Gtk::SpinButton's default ctor takes no args
// (or an optional adjustment which we don't use). We forward zero
// args; range/increments/digits are setter-style after.
