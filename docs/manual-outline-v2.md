...
Addendums                                                                                 (NEW chapter — outside numbered sequence)
  Developer
    ...
    [D] Canvas & objects reference                     → addendum-developer-scripter-canvas-objects.md (s284 m1)
    [D] Dialogs & popovers reference                   → addendum-developer-scripter-dialogs.md       (s284 m2)
