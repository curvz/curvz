...
private:
    ...
    Gtk::SpinButton m_pos_spin;
    Gtk::SpinButton m_opacity_spin;
    ...
    Gtk::SpinButton  m_angle_spin;
    Gtk::Label*      m_lbl_angle = nullptr;
    // Linear endpoints
    Gtk::SpinButton m_x1_spin;
    Gtk::SpinButton m_y1_spin;
    Gtk::SpinButton m_x2_spin;
    Gtk::SpinButton m_y2_spin;
    // Radial extras
    Gtk::SpinButton m_r_spin;
    ...
    void draw_angle_knob(const Cairo::RefPtr<Cairo::Context>& cr,
                         int w, int h);
