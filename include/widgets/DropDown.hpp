...
class DropDown : public curvz::scripting::ScriptableWidget<Gtk::DropDown> {
public:
  DropDown(std::string_view name, const std::vector<Glib::ustring> &options);
  ...
  DropDown(std::string_view name, const Glib::RefPtr<Gtk::StringList> &model);
