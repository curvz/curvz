...
class Scale : public curvz::scripting::ScriptableWidget<Gtk::Scale> {
public:
  Scale(std::string_view name, double min, double max, double step);
  ...
  Scale(std::string_view name, Glib::RefPtr<Gtk::Adjustment> adj,
