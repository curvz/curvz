// curvz/widgets/RefPointPicker.hpp ──────────────────────────────────────────
//
...
class RefPointPicker
    : public curvz::scripting::ScriptableWidget<Gtk::Box> {
public:
...
private:
    ...
    void   on_grid_draw(const Cairo::RefPtr<Cairo::Context>& cr,
