// scripting/ScriptableRegistry.hpp ───────────────────────────────────────────
//
...
//
// Lifted from scriptproto/ during s186 m2. Compiles into production
// builds (cheap — the cost is one std::unordered_map and a few
// hundred registrations); only the listener and Scripter window are
// gated by CURVZ_DIAGNOSTIC.
